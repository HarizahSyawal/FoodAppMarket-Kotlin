...
import com.hariz.foodmarketapp.ui.home.popular.HomePopularAdapter
import kotlinx.android.synthetic.main.fragment_home.*

class HomeRecommendedFragment : Fragment(), HomeRecommendedAdapter.ItemAdapterCallback {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initDummy()
        var adapter = HomeRecommendedAdapter(foodList, this)
